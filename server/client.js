...
exports.start = async (session, models, vars) => {
    ...
    vars.session.newIssueCategories = {
        computer: {
            ...
            serviceClassification: ['Desktop Management', 'Computer', 'Submit Incident'],
        ...
        desk: {
            ...
            list: [
                ...
                { title: 'phone', serviceClassification: ['Telephony / Fax', 'Desktop Telephone', 'Submit Incident']},
                { title: 'other' }
            ],
            serviceClassification: ['Desktop Management', 'Computer', 'Submit Incident'],
        ...
        printer: {
            ...
            suffix: 'as it',
            list: [
                { title: 'won\'t setup Follow-Me printing', serviceClassification: ['Printing', 'Network', 'Submit Incident'] },
                { title: 'is unable to print' },
                { title: 'other' }
            ],
            serviceClassification: ['Printing', 'Desktop', 'Submit Incident'],
        ...
        applications: {
            ...
            suffix: 'specifically',
            list: [
                { title: 'Microsoft Office', serviceClassification: ['Enterprise Apps', 'Microsoft Office', 'Submit Incident'] },
                { title: 'SalesForce', serviceClassification: ['Enterprise Apps', 'CRM/Sales Software', 'Submit Incident'] },
                { title: 'Anti-Virus', serviceClassification: ['Desktop Management', 'Anti-Virus', 'Submit Incident'] },
                { title: 'Jabber/Webex' },
                { title: 'other' }
            ],
            serviceClassification: ['Desktop Management', 'Misc. Software', 'Submit Incident'],
    ...
    vars.session.defaultServiceClassification = ['IT Service Desk', 'Report Outage or Error', 'Submit Incident'];
    vars.session.urgencyDefaultValue = 'Medium'; //2;
